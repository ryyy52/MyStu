...
<body>
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/user/login" method="post">
            ...
            <label style="display:block;margin:8px 0;color:#555;">
                <input type="checkbox" name="rememberMe" /> 记住我（7天）
            </label>
            <div style="margin: 10px 0;">
                <input type="text" name="captcha" placeholder="验证码" required style="width: 60%; margin-right: 10px;" maxlength="4">
                <img id="captchaImage" src="${pageContext.request.contextPath}/captcha" alt="验证码" style="height: 40px; vertical-align: middle; cursor: pointer;">
            </div>
