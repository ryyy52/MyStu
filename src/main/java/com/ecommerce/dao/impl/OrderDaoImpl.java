 ...
 * 
 * 主要方法：
 * - findById/findByOrderNo: 单个订单查询
 * - findByUserId/findAll: 订单列表查询
 * - save/update/delete: 订单CRUD操作
 * - findOrderItemsByOrderId/saveOrderItem: 订单商品管理
 * - countAll/getTotalSales: 订单数据统计
 * 
 * 订单状态流转：
 * - 0: 待付款（用户刚创建订单）
 * - 1: 待发货（用户已付款，准备发货）
 ...
 * 
 * 数据库表：
 * - order: 订单表（id、order_no、user_id、total_amount、status、receiver_info等）
